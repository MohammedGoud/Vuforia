...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="index.html"><img src="{{url('')}}/assets_admin/assests/images/logo_light.png" alt=""></a>
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <!-- Simple login form -->
                {{--{!! Form::open(['method' => 'Post','route' => ['mzadqater_admin.login.login'] ,'class'=>'form-horizontal form-validate-jquery' ]) !!}--}}
                   <form action="{{url('admin/validenter')}}" method="post">
                       {{ csrf_field() }}
