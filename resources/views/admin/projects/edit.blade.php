            ...
            <div class="panel-body">
                    ...
                    <fieldset class="content-group">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="title" class="form-control" required="required" value="{{isset($project->title)?$project->title:''}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                           <textarea name="breif" rows="5" cols="5" class="form-control" >{{isset($project->breif)?strip_tags($project->breif):''}}
								</textarea>
                            </div>
                        </div>
