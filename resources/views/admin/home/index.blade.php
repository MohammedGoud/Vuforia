...
<!-- Theme JS files -->
<script type="text/javascript" src="{{url('')}}/assets_admin/assests/js/plugins/visualization/d3/d3.min.js"></script>
<script type="text/javascript" src="{{url('')}}/assets_admin/assests/js/plugins/visualization/d3/d3_tooltip.js"></script>
...
<script type="text/javascript" src="{{url('')}}/assets_admin/assests/js/plugins/ui/moment/moment.min.js"></script>
<script type="text/javascript" src="{{url('')}}/assets_admin/assests/js/plugins/pickers/daterangepicker.js"></script>
