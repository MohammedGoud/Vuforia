...
$(function () {
    ...
    var line_chart = c3.generate({
        ...
        data: {
            columns: [
                ['algeria', 30, 200, 100, 400, 150, 250],
                ['egypt', 50, 20, 78, 40, 15, 25],
                ['America', 50, 70, 10, 40, 15, 25],
                ['UK', 50, 80, 10, 50, 150, 25],
                ['Emirates', 505, 44, 100, 400, 15, 25]
            ],
            type: 'spline'
        },
        grid: {
            ...
            x: {
                type: 'category',
                categories: ['1/4', '2/4', '3/4', '4/4', '5/4', '6/4']
            }
        },
    });
